...
/*
    ...
    OID: iso.identified-organization.dod.internet.security.mechanisms.pkix.id-mod.id-mod-pkcs10-2009
    IRI: undefined
    EXTENSIBLE: false
...
let _cached_decoder_for_CertificationRequestInfo_version: __utils.ASN1Decoder<CertificationRequestInfo_version> | null = null;
let _cached_encoder_for_CertificationRequestInfo_version: __utils.ASN1Encoder<CertificationRequestInfo_version> | null = null;
export function _decode_CertificationRequestInfo_version (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertificationRequestInfo_version) { _cached_decoder_for_CertificationRequestInfo_version = __utils._decodeInteger; }
    return _cached_decoder_for_CertificationRequestInfo_version(el);
}
export function _encode_CertificationRequestInfo_version (value: CertificationRequestInfo_version, elGetter: __utils.ASN1Encoder<CertificationRequestInfo_version>) {
    if (!_cached_encoder_for_CertificationRequestInfo_version) { _cached_encoder_for_CertificationRequestInfo_version = __utils._encodeInteger; }
...
export class Attribute {
    constructor (
        readonly type_: asn1.ASN1Element /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */,
        readonly values: asn1.ASN1Element /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */[]
    ) {}

}
export const _root_component_type_list_1_spec_for_Attribute: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("type", false, __utils.hasAnyTag, undefined, undefined),
...
export function _decode_Attribute (el: asn1.ASN1Element) {
    ...
    let type_!: asn1.ASN1Element /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */;
    let values!: asn1.ASN1Element /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */[];
    type_ = __utils._decodeAny /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */(sequence[0]);
    values = __utils._decodeSetOf<asn1.ASN1Element /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */>(() => __utils._decodeAny /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */)(sequence[1]);
    // TODO: Validate values.
...
export function _encode_Attribute (value: Attribute, elGetter: __utils.ASN1Encoder<Attribute>) {
    ...
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeAny /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */(value.type_, __utils.BER),
            /* REQUIRED   */ __utils._encodeSetOf<asn1.ASN1Element /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */>(() => __utils._encodeAny /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */, __utils.BER)(value.values, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
export const _root_component_type_list_1_spec_for_CertificationRequestInfo: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("subjectPKInfo", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
...
let _cached_decoder_for_CertificationRequestInfo: __utils.ASN1Decoder<CertificationRequestInfo> | null = null;
let _cached_encoder_for_CertificationRequestInfo: __utils.ASN1Encoder<CertificationRequestInfo> | null = null;
export function _decode_CertificationRequestInfo (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertificationRequestInfo) { _cached_decoder_for_CertificationRequestInfo = function (el: asn1.ASN1Element): CertificationRequestInfo {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 4) {
        throw new asn1.ASN1ConstructionError("CertificationRequestInfo contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    attributes = __utils._decode_implicit<Attributes>(() => _decode_Attributes)(sequence[3]);
    // TODO: Validate values.
...
export function _encode_CertificationRequestInfo (value: CertificationRequestInfo, elGetter: __utils.ASN1Encoder<CertificationRequestInfo>) {
    if (!_cached_encoder_for_CertificationRequestInfo) { _cached_encoder_for_CertificationRequestInfo = function (value: CertificationRequestInfo, elGetter: __utils.ASN1Encoder<CertificationRequestInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_CertificationRequestInfo_version(value.version, __utils.BER),
            /* REQUIRED   */ _encode_Name(value.subject, __utils.BER),
            /* REQUIRED   */ _encode_SubjectPublicKeyInfo(value.subjectPKInfo, __utils.BER),
            /* REQUIRED   */ __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _encode_Attributes, __utils.BER)(value.attributes, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
export const _root_component_type_list_1_spec_for_CertificationRequest: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("certificationRequestInfo", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
...
let _cached_decoder_for_CertificationRequest: __utils.ASN1Decoder<CertificationRequest> | null = null;
let _cached_encoder_for_CertificationRequest: __utils.ASN1Encoder<CertificationRequest> | null = null;
export function _decode_CertificationRequest (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertificationRequest) { _cached_decoder_for_CertificationRequest = function (el: asn1.ASN1Element): CertificationRequest {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new asn1.ASN1ConstructionError("CertificationRequest contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export function _encode_CertificationRequest (value: CertificationRequest, elGetter: __utils.ASN1Encoder<CertificationRequest>) {
    if (!_cached_encoder_for_CertificationRequest) { _cached_encoder_for_CertificationRequest = function (value: CertificationRequest, elGetter: __utils.ASN1Encoder<CertificationRequest>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_CertificationRequestInfo(value.certificationRequestInfo, __utils.BER),
