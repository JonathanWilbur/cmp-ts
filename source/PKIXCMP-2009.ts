...
let _cached_decoder_for_PKIHeader_pvno: __utils.ASN1Decoder<PKIHeader_pvno> | null = null;
let _cached_encoder_for_PKIHeader_pvno: __utils.ASN1Encoder<PKIHeader_pvno> | null = null;
export function _decode_PKIHeader_pvno (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIHeader_pvno) { _cached_decoder_for_PKIHeader_pvno = __utils._decodeInteger; }
    return _cached_decoder_for_PKIHeader_pvno(el);
}
export function _encode_PKIHeader_pvno (value: PKIHeader_pvno, elGetter: __utils.ASN1Encoder<PKIHeader_pvno>) {
    if (!_cached_encoder_for_PKIHeader_pvno) { _cached_encoder_for_PKIHeader_pvno = __utils._encodeInteger; }
    return _cached_encoder_for_PKIHeader_pvno(value, elGetter);
}


export type PKIFreeText = asn1.UTF8String[]; // SequenceOfType
let _cached_decoder_for_PKIFreeText: __utils.ASN1Decoder<PKIFreeText> | null = null;
let _cached_encoder_for_PKIFreeText: __utils.ASN1Encoder<PKIFreeText> | null = null;
export function _decode_PKIFreeText (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIFreeText) { _cached_decoder_for_PKIFreeText = __utils._decodeSequenceOf<asn1.UTF8String>(() => __utils._decodeUTF8String); }
    return _cached_decoder_for_PKIFreeText(el);
}
export function _encode_PKIFreeText (value: PKIFreeText, elGetter: __utils.ASN1Encoder<PKIFreeText>) {
    if (!_cached_encoder_for_PKIFreeText) { _cached_encoder_for_PKIFreeText = __utils._encodeSequenceOf<asn1.UTF8String>(() => __utils._encodeUTF8String, __utils.BER); }
...
let _cached_decoder_for_InfoTypeAndValue: __utils.ASN1Decoder<InfoTypeAndValue> | null = null;
let _cached_encoder_for_InfoTypeAndValue: __utils.ASN1Encoder<InfoTypeAndValue> | null = null;
export function _decode_InfoTypeAndValue (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_InfoTypeAndValue) { _cached_decoder_for_InfoTypeAndValue = function (el: asn1.ASN1Element): InfoTypeAndValue {
...
export function _encode_InfoTypeAndValue (value: InfoTypeAndValue, elGetter: __utils.ASN1Encoder<InfoTypeAndValue>) {
    if (!_cached_encoder_for_InfoTypeAndValue) { _cached_encoder_for_InfoTypeAndValue = function (value: InfoTypeAndValue, elGetter: __utils.ASN1Encoder<InfoTypeAndValue>): asn1.ASN1Element {
...
export const _root_component_type_list_1_spec_for_PKIHeader: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("sender", false, __utils.hasAnyTag, undefined, undefined),
    new __utils.ComponentSpec("recipient", false, __utils.hasAnyTag, undefined, undefined),
    ...
    new __utils.ComponentSpec("senderKID", true, __utils.hasTag(asn1.ASN1TagClass.context, 2), undefined, undefined),
    new __utils.ComponentSpec("recipKID", true, __utils.hasTag(asn1.ASN1TagClass.context, 3), undefined, undefined),
...
export function _decode_PKIHeader (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIHeader) { _cached_decoder_for_PKIHeader = function (el: asn1.ASN1Element): PKIHeader {
...
export function _encode_PKIHeader (value: PKIHeader, elGetter: __utils.ASN1Encoder<PKIHeader>) {
    if (!_cached_encoder_for_PKIHeader) { _cached_encoder_for_PKIHeader = function (value: PKIHeader, elGetter: __utils.ASN1Encoder<PKIHeader>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_CMPCertificate: __utils.ASN1Decoder<CMPCertificate> | null = null;
let _cached_encoder_for_CMPCertificate: __utils.ASN1Encoder<CMPCertificate> | null = null;
export function _decode_CMPCertificate (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CMPCertificate) { _cached_decoder_for_CMPCertificate = __utils._decode_extensible_choice<CMPCertificate>({
    "UNIVERSAL 16": [ "x509v3PKCert", _decode_Certificate ]
}); }
    return _cached_decoder_for_CMPCertificate(el);
}
export function _encode_CMPCertificate (value: CMPCertificate, elGetter: __utils.ASN1Encoder<CMPCertificate>) {
    if (!_cached_encoder_for_CMPCertificate) { _cached_encoder_for_CMPCertificate = __utils._encode_choice<CMPCertificate>({
...
export function _decode_PKIStatus (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIStatus) { _cached_decoder_for_PKIStatus = __utils._decodeInteger; }
    return _cached_decoder_for_PKIStatus(el);
}
export function _encode_PKIStatus (value: PKIStatus, elGetter: __utils.ASN1Encoder<PKIStatus>) {
    if (!_cached_encoder_for_PKIStatus) { _cached_encoder_for_PKIStatus = __utils._encodeInteger; }
...
let _cached_decoder_for_PKIFailureInfo: __utils.ASN1Decoder<PKIFailureInfo> | null = null;
let _cached_encoder_for_PKIFailureInfo: __utils.ASN1Encoder<PKIFailureInfo> | null = null;
export function _decode_PKIFailureInfo (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIFailureInfo) { _cached_decoder_for_PKIFailureInfo = __utils._decodeBitString; }
    return _cached_decoder_for_PKIFailureInfo(el);
}
export function _encode_PKIFailureInfo (value: PKIFailureInfo, elGetter: __utils.ASN1Encoder<PKIFailureInfo>) {
    if (!_cached_encoder_for_PKIFailureInfo) { _cached_encoder_for_PKIFailureInfo = __utils._encodeBitString; }
...
let _cached_decoder_for_PKIStatusInfo: __utils.ASN1Decoder<PKIStatusInfo> | null = null;
let _cached_encoder_for_PKIStatusInfo: __utils.ASN1Encoder<PKIStatusInfo> | null = null;
export function _decode_PKIStatusInfo (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIStatusInfo) { _cached_decoder_for_PKIStatusInfo = function (el: asn1.ASN1Element): PKIStatusInfo {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_PKIStatusInfo (value: PKIStatusInfo, elGetter: __utils.ASN1Encoder<PKIStatusInfo>) {
    if (!_cached_encoder_for_PKIStatusInfo) { _cached_encoder_for_PKIStatusInfo = function (value: PKIStatusInfo, elGetter: __utils.ASN1Encoder<PKIStatusInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_CertOrEncCert: __utils.ASN1Decoder<CertOrEncCert> | null = null;
let _cached_encoder_for_CertOrEncCert: __utils.ASN1Encoder<CertOrEncCert> | null = null;
export function _decode_CertOrEncCert (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertOrEncCert) { _cached_decoder_for_CertOrEncCert = __utils._decode_inextensible_choice<CertOrEncCert>({
...
export function _encode_CertOrEncCert (value: CertOrEncCert, elGetter: __utils.ASN1Encoder<CertOrEncCert>) {
    if (!_cached_encoder_for_CertOrEncCert) { _cached_encoder_for_CertOrEncCert = __utils._encode_choice<CertOrEncCert>({
...
export const _root_component_type_list_1_spec_for_CertifiedKeyPair: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("privateKey", true, __utils.hasTag(asn1.ASN1TagClass.context, 0), undefined, undefined),
    new __utils.ComponentSpec("publicationInfo", true, __utils.hasTag(asn1.ASN1TagClass.context, 1), undefined, undefined)
];
...
let _cached_decoder_for_CertifiedKeyPair: __utils.ASN1Decoder<CertifiedKeyPair> | null = null;
let _cached_encoder_for_CertifiedKeyPair: __utils.ASN1Encoder<CertifiedKeyPair> | null = null;
export function _decode_CertifiedKeyPair (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertifiedKeyPair) { _cached_decoder_for_CertifiedKeyPair = function (el: asn1.ASN1Element): CertifiedKeyPair {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_CertifiedKeyPair (value: CertifiedKeyPair, elGetter: __utils.ASN1Encoder<CertifiedKeyPair>) {
    if (!_cached_encoder_for_CertifiedKeyPair) { _cached_encoder_for_CertifiedKeyPair = function (value: CertifiedKeyPair, elGetter: __utils.ASN1Encoder<CertifiedKeyPair>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_CertResponse: __utils.ASN1Decoder<CertResponse> | null = null;
let _cached_encoder_for_CertResponse: __utils.ASN1Encoder<CertResponse> | null = null;
export function _decode_CertResponse (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertResponse) { _cached_decoder_for_CertResponse = function (el: asn1.ASN1Element): CertResponse {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_CertResponse (value: CertResponse, elGetter: __utils.ASN1Encoder<CertResponse>) {
    if (!_cached_encoder_for_CertResponse) { _cached_encoder_for_CertResponse = function (value: CertResponse, elGetter: __utils.ASN1Encoder<CertResponse>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_CertRepMessage: __utils.ASN1Decoder<CertRepMessage> | null = null;
let _cached_encoder_for_CertRepMessage: __utils.ASN1Encoder<CertRepMessage> | null = null;
export function _decode_CertRepMessage (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertRepMessage) { _cached_decoder_for_CertRepMessage = function (el: asn1.ASN1Element): CertRepMessage {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_CertRepMessage (value: CertRepMessage, elGetter: __utils.ASN1Encoder<CertRepMessage>) {
    if (!_cached_encoder_for_CertRepMessage) { _cached_encoder_for_CertRepMessage = function (value: CertRepMessage, elGetter: __utils.ASN1Encoder<CertRepMessage>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export function _decode_Challenge (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_Challenge) { _cached_decoder_for_Challenge = function (el: asn1.ASN1Element): Challenge {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_Challenge (value: Challenge, elGetter: __utils.ASN1Encoder<Challenge>) {
    if (!_cached_encoder_for_Challenge) { _cached_encoder_for_Challenge = function (value: Challenge, elGetter: __utils.ASN1Encoder<Challenge>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_POPODecKeyChallContent: __utils.ASN1Decoder<POPODecKeyChallContent> | null = null;
let _cached_encoder_for_POPODecKeyChallContent: __utils.ASN1Encoder<POPODecKeyChallContent> | null = null;
export function _decode_POPODecKeyChallContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_POPODecKeyChallContent) { _cached_decoder_for_POPODecKeyChallContent = __utils._decodeSequenceOf<Challenge>(() => _decode_Challenge); }
    return _cached_decoder_for_POPODecKeyChallContent(el);
}
export function _encode_POPODecKeyChallContent (value: POPODecKeyChallContent, elGetter: __utils.ASN1Encoder<POPODecKeyChallContent>) {
    if (!_cached_encoder_for_POPODecKeyChallContent) { _cached_encoder_for_POPODecKeyChallContent = __utils._encodeSequenceOf<Challenge>(() => _encode_Challenge, __utils.BER); }
...
let _cached_decoder_for_POPODecKeyRespContent: __utils.ASN1Decoder<POPODecKeyRespContent> | null = null;
let _cached_encoder_for_POPODecKeyRespContent: __utils.ASN1Encoder<POPODecKeyRespContent> | null = null;
export function _decode_POPODecKeyRespContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_POPODecKeyRespContent) { _cached_decoder_for_POPODecKeyRespContent = __utils._decodeSequenceOf<asn1.INTEGER>(() => __utils._decodeInteger); }
    return _cached_decoder_for_POPODecKeyRespContent(el);
}
export function _encode_POPODecKeyRespContent (value: POPODecKeyRespContent, elGetter: __utils.ASN1Encoder<POPODecKeyRespContent>) {
    if (!_cached_encoder_for_POPODecKeyRespContent) { _cached_encoder_for_POPODecKeyRespContent = __utils._encodeSequenceOf<asn1.INTEGER>(() => __utils._encodeInteger, __utils.BER); }
...
let _cached_decoder_for_KeyRecRepContent: __utils.ASN1Decoder<KeyRecRepContent> | null = null;
let _cached_encoder_for_KeyRecRepContent: __utils.ASN1Encoder<KeyRecRepContent> | null = null;
export function _decode_KeyRecRepContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_KeyRecRepContent) { _cached_decoder_for_KeyRecRepContent = function (el: asn1.ASN1Element): KeyRecRepContent {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let status!: PKIStatusInfo;
...
export function _encode_KeyRecRepContent (value: KeyRecRepContent, elGetter: __utils.ASN1Encoder<KeyRecRepContent>) {
    if (!_cached_encoder_for_KeyRecRepContent) { _cached_encoder_for_KeyRecRepContent = function (value: KeyRecRepContent, elGetter: __utils.ASN1Encoder<KeyRecRepContent>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_PKIStatusInfo(value.status, __utils.BER),
...
export const _root_component_type_list_1_spec_for_RevDetails: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("certDetails", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
...
let _cached_decoder_for_RevDetails: __utils.ASN1Decoder<RevDetails> | null = null;
let _cached_encoder_for_RevDetails: __utils.ASN1Encoder<RevDetails> | null = null;
export function _decode_RevDetails (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevDetails) { _cached_decoder_for_RevDetails = function (el: asn1.ASN1Element): RevDetails {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_RevDetails (value: RevDetails, elGetter: __utils.ASN1Encoder<RevDetails>) {
    if (!_cached_encoder_for_RevDetails) { _cached_encoder_for_RevDetails = function (value: RevDetails, elGetter: __utils.ASN1Encoder<RevDetails>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_RevReqContent: __utils.ASN1Decoder<RevReqContent> | null = null;
let _cached_encoder_for_RevReqContent: __utils.ASN1Encoder<RevReqContent> | null = null;
export function _decode_RevReqContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevReqContent) { _cached_decoder_for_RevReqContent = __utils._decodeSequenceOf<RevDetails>(() => _decode_RevDetails); }
    return _cached_decoder_for_RevReqContent(el);
}
export function _encode_RevReqContent (value: RevReqContent, elGetter: __utils.ASN1Encoder<RevReqContent>) {
    if (!_cached_encoder_for_RevReqContent) { _cached_encoder_for_RevReqContent = __utils._encodeSequenceOf<RevDetails>(() => _encode_RevDetails, __utils.BER); }
...
let _cached_decoder_for_RevRepContent: __utils.ASN1Decoder<RevRepContent> | null = null;
let _cached_encoder_for_RevRepContent: __utils.ASN1Encoder<RevRepContent> | null = null;
export function _decode_RevRepContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevRepContent) { _cached_decoder_for_RevRepContent = function (el: asn1.ASN1Element): RevRepContent {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let status!: PKIStatusInfo[];
...
export function _encode_RevRepContent (value: RevRepContent, elGetter: __utils.ASN1Encoder<RevRepContent>) {
    if (!_cached_encoder_for_RevRepContent) { _cached_encoder_for_RevRepContent = function (value: RevRepContent, elGetter: __utils.ASN1Encoder<RevRepContent>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_CAKeyUpdAnnContent: __utils.ASN1Decoder<CAKeyUpdAnnContent> | null = null;
let _cached_encoder_for_CAKeyUpdAnnContent: __utils.ASN1Encoder<CAKeyUpdAnnContent> | null = null;
export function _decode_CAKeyUpdAnnContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CAKeyUpdAnnContent) { _cached_decoder_for_CAKeyUpdAnnContent = function (el: asn1.ASN1Element): CAKeyUpdAnnContent {
    const sequence: asn1.ASN1Element[] = el.sequence;
...
export function _encode_CAKeyUpdAnnContent (value: CAKeyUpdAnnContent, elGetter: __utils.ASN1Encoder<CAKeyUpdAnnContent>) {
    if (!_cached_encoder_for_CAKeyUpdAnnContent) { _cached_encoder_for_CAKeyUpdAnnContent = function (value: CAKeyUpdAnnContent, elGetter: __utils.ASN1Encoder<CAKeyUpdAnnContent>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_CertAnnContent: __utils.ASN1Decoder<CertAnnContent> | null = null;
let _cached_encoder_for_CertAnnContent: __utils.ASN1Encoder<CertAnnContent> | null = null;
export function _decode_CertAnnContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertAnnContent) { _cached_decoder_for_CertAnnContent = _decode_CMPCertificate; }
    return _cached_decoder_for_CertAnnContent(el);
}
export function _encode_CertAnnContent (value: CertAnnContent, elGetter: __utils.ASN1Encoder<CertAnnContent>) {
    if (!_cached_encoder_for_CertAnnContent) { _cached_encoder_for_CertAnnContent = _encode_CMPCertificate; }
...
let _cached_decoder_for_RevAnnContent: __utils.ASN1Decoder<RevAnnContent> | null = null;
let _cached_encoder_for_RevAnnContent: __utils.ASN1Encoder<RevAnnContent> | null = null;
export function _decode_RevAnnContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevAnnContent) { _cached_decoder_for_RevAnnContent = function (el: asn1.ASN1Element): RevAnnContent {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let status!: PKIStatus;
    let certId!: CertId;
...
export function _encode_RevAnnContent (value: RevAnnContent, elGetter: __utils.ASN1Encoder<RevAnnContent>) {
    if (!_cached_encoder_for_RevAnnContent) { _cached_encoder_for_RevAnnContent = function (value: RevAnnContent, elGetter: __utils.ASN1Encoder<RevAnnContent>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_PKIStatus(value.status, __utils.BER),
...
let _cached_decoder_for_CRLAnnContent: __utils.ASN1Decoder<CRLAnnContent> | null = null;
let _cached_encoder_for_CRLAnnContent: __utils.ASN1Encoder<CRLAnnContent> | null = null;
export function _decode_CRLAnnContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CRLAnnContent) { _cached_decoder_for_CRLAnnContent = __utils._decodeSequenceOf<CertificateList>(() => _decode_CertificateList); }
    return _cached_decoder_for_CRLAnnContent(el);
}
export function _encode_CRLAnnContent (value: CRLAnnContent, elGetter: __utils.ASN1Encoder<CRLAnnContent>) {
    if (!_cached_encoder_for_CRLAnnContent) { _cached_encoder_for_CRLAnnContent = __utils._encodeSequenceOf<CertificateList>(() => _encode_CertificateList, __utils.BER); }
    return _cached_encoder_for_CRLAnnContent(value, elGetter);
}


export type PKIConfirmContent = asn1.NULL; // NullType
let _cached_decoder_for_PKIConfirmContent: __utils.ASN1Decoder<PKIConfirmContent> | null = null;
let _cached_encoder_for_PKIConfirmContent: __utils.ASN1Encoder<PKIConfirmContent> | null = null;
export function _decode_PKIConfirmContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIConfirmContent) { _cached_decoder_for_PKIConfirmContent = __utils._decodeNull; }
    return _cached_decoder_for_PKIConfirmContent(el);
}
export function _encode_PKIConfirmContent (value: PKIConfirmContent, elGetter: __utils.ASN1Encoder<PKIConfirmContent>) {
    if (!_cached_encoder_for_PKIConfirmContent) { _cached_encoder_for_PKIConfirmContent = __utils._encodeNull; }
    return _cached_encoder_for_PKIConfirmContent(value, elGetter);
}


export type PKIProtection = asn1.BIT_STRING;
let _cached_decoder_for_PKIProtection: __utils.ASN1Decoder<PKIProtection> | null = null;
let _cached_encoder_for_PKIProtection: __utils.ASN1Encoder<PKIProtection> | null = null;
export function _decode_PKIProtection (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIProtection) { _cached_decoder_for_PKIProtection = __utils._decodeBitString; }
    return _cached_decoder_for_PKIProtection(el);
}
export function _encode_PKIProtection (value: PKIProtection, elGetter: __utils.ASN1Encoder<PKIProtection>) {
    if (!_cached_encoder_for_PKIProtection) { _cached_encoder_for_PKIProtection = __utils._encodeBitString; }
...
let _cached_decoder_for_PKIMessage: __utils.ASN1Decoder<PKIMessage> | null = null;
let _cached_encoder_for_PKIMessage: __utils.ASN1Encoder<PKIMessage> | null = null;
export function _decode_PKIMessage (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIMessage) { _cached_decoder_for_PKIMessage = function (el: asn1.ASN1Element): PKIMessage {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_PKIMessage (value: PKIMessage, elGetter: __utils.ASN1Encoder<PKIMessage>) {
    if (!_cached_encoder_for_PKIMessage) { _cached_encoder_for_PKIMessage = function (value: PKIMessage, elGetter: __utils.ASN1Encoder<PKIMessage>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_PKIMessages: __utils.ASN1Decoder<PKIMessages> | null = null;
let _cached_encoder_for_PKIMessages: __utils.ASN1Encoder<PKIMessages> | null = null;
export function _decode_PKIMessages (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIMessages) { _cached_decoder_for_PKIMessages = __utils._decodeSequenceOf<PKIMessage>(() => _decode_PKIMessage); }
    return _cached_decoder_for_PKIMessages(el);
}
export function _encode_PKIMessages (value: PKIMessages, elGetter: __utils.ASN1Encoder<PKIMessages>) {
    if (!_cached_encoder_for_PKIMessages) { _cached_encoder_for_PKIMessages = __utils._encodeSequenceOf<PKIMessage>(() => _encode_PKIMessage, __utils.BER); }
    return _cached_encoder_for_PKIMessages(value, elGetter);
}


export type NestedMessageContent = PKIMessages; // DefinedType
let _cached_decoder_for_NestedMessageContent: __utils.ASN1Decoder<NestedMessageContent> | null = null;
let _cached_encoder_for_NestedMessageContent: __utils.ASN1Encoder<NestedMessageContent> | null = null;
export function _decode_NestedMessageContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_NestedMessageContent) { _cached_decoder_for_NestedMessageContent = _decode_PKIMessages; }
    return _cached_decoder_for_NestedMessageContent(el);
}
export function _encode_NestedMessageContent (value: NestedMessageContent, elGetter: __utils.ASN1Encoder<NestedMessageContent>) {
    if (!_cached_encoder_for_NestedMessageContent) { _cached_encoder_for_NestedMessageContent = _encode_PKIMessages; }
    return _cached_encoder_for_NestedMessageContent(value, elGetter);
}


export type GenMsgContent = InfoTypeAndValue[]; // SequenceOfType
let _cached_decoder_for_GenMsgContent: __utils.ASN1Decoder<GenMsgContent> | null = null;
let _cached_encoder_for_GenMsgContent: __utils.ASN1Encoder<GenMsgContent> | null = null;
export function _decode_GenMsgContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_GenMsgContent) { _cached_decoder_for_GenMsgContent = __utils._decodeSequenceOf<InfoTypeAndValue>(() => _decode_InfoTypeAndValue); }
    return _cached_decoder_for_GenMsgContent(el);
}
export function _encode_GenMsgContent (value: GenMsgContent, elGetter: __utils.ASN1Encoder<GenMsgContent>) {
    if (!_cached_encoder_for_GenMsgContent) { _cached_encoder_for_GenMsgContent = __utils._encodeSequenceOf<InfoTypeAndValue>(() => _encode_InfoTypeAndValue, __utils.BER); }
    return _cached_encoder_for_GenMsgContent(value, elGetter);
}


export type GenRepContent = InfoTypeAndValue[]; // SequenceOfType
let _cached_decoder_for_GenRepContent: __utils.ASN1Decoder<GenRepContent> | null = null;
let _cached_encoder_for_GenRepContent: __utils.ASN1Encoder<GenRepContent> | null = null;
export function _decode_GenRepContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_GenRepContent) { _cached_decoder_for_GenRepContent = __utils._decodeSequenceOf<InfoTypeAndValue>(() => _decode_InfoTypeAndValue); }
    return _cached_decoder_for_GenRepContent(el);
}
export function _encode_GenRepContent (value: GenRepContent, elGetter: __utils.ASN1Encoder<GenRepContent>) {
    if (!_cached_encoder_for_GenRepContent) { _cached_encoder_for_GenRepContent = __utils._encodeSequenceOf<InfoTypeAndValue>(() => _encode_InfoTypeAndValue, __utils.BER); }
...
let _cached_decoder_for_ErrorMsgContent: __utils.ASN1Decoder<ErrorMsgContent> | null = null;
let _cached_encoder_for_ErrorMsgContent: __utils.ASN1Encoder<ErrorMsgContent> | null = null;
export function _decode_ErrorMsgContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ErrorMsgContent) { _cached_decoder_for_ErrorMsgContent = function (el: asn1.ASN1Element): ErrorMsgContent {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_ErrorMsgContent (value: ErrorMsgContent, elGetter: __utils.ASN1Encoder<ErrorMsgContent>) {
    if (!_cached_encoder_for_ErrorMsgContent) { _cached_encoder_for_ErrorMsgContent = function (value: ErrorMsgContent, elGetter: __utils.ASN1Encoder<ErrorMsgContent>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export function _decode_CertStatus (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertStatus) { _cached_decoder_for_CertStatus = function (el: asn1.ASN1Element): CertStatus {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_CertStatus (value: CertStatus, elGetter: __utils.ASN1Encoder<CertStatus>) {
    if (!_cached_encoder_for_CertStatus) { _cached_encoder_for_CertStatus = function (value: CertStatus, elGetter: __utils.ASN1Encoder<CertStatus>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
let _cached_decoder_for_CertConfirmContent: __utils.ASN1Decoder<CertConfirmContent> | null = null;
let _cached_encoder_for_CertConfirmContent: __utils.ASN1Encoder<CertConfirmContent> | null = null;
export function _decode_CertConfirmContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertConfirmContent) { _cached_decoder_for_CertConfirmContent = __utils._decodeSequenceOf<CertStatus>(() => _decode_CertStatus); }
    return _cached_decoder_for_CertConfirmContent(el);
}
export function _encode_CertConfirmContent (value: CertConfirmContent, elGetter: __utils.ASN1Encoder<CertConfirmContent>) {
    if (!_cached_encoder_for_CertConfirmContent) { _cached_encoder_for_CertConfirmContent = __utils._encodeSequenceOf<CertStatus>(() => _encode_CertStatus, __utils.BER); }
...
let _cached_decoder_for_PollReqContent_Item: __utils.ASN1Decoder<PollReqContent_Item> | null = null;
let _cached_encoder_for_PollReqContent_Item: __utils.ASN1Encoder<PollReqContent_Item> | null = null;
export function _decode_PollReqContent_Item (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PollReqContent_Item) { _cached_decoder_for_PollReqContent_Item = function (el: asn1.ASN1Element): PollReqContent_Item {
    const sequence: asn1.ASN1Element[] = el.sequence;
...
export function _encode_PollReqContent_Item (value: PollReqContent_Item, elGetter: __utils.ASN1Encoder<PollReqContent_Item>) {
    if (!_cached_encoder_for_PollReqContent_Item) { _cached_encoder_for_PollReqContent_Item = function (value: PollReqContent_Item, elGetter: __utils.ASN1Encoder<PollReqContent_Item>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeInteger(value.certReqId, __utils.BER)
        ],
...
let _cached_decoder_for_PollReqContent: __utils.ASN1Decoder<PollReqContent> | null = null;
let _cached_encoder_for_PollReqContent: __utils.ASN1Encoder<PollReqContent> | null = null;
export function _decode_PollReqContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PollReqContent) { _cached_decoder_for_PollReqContent = __utils._decodeSequenceOf<PollReqContent_Item>(() => _decode_PollReqContent_Item); }
    return _cached_decoder_for_PollReqContent(el);
}
export function _encode_PollReqContent (value: PollReqContent, elGetter: __utils.ASN1Encoder<PollReqContent>) {
    if (!_cached_encoder_for_PollReqContent) { _cached_encoder_for_PollReqContent = __utils._encodeSequenceOf<PollReqContent_Item>(() => _encode_PollReqContent_Item, __utils.BER); }
...
let _cached_decoder_for_PollRepContent_Item: __utils.ASN1Decoder<PollRepContent_Item> | null = null;
let _cached_encoder_for_PollRepContent_Item: __utils.ASN1Encoder<PollRepContent_Item> | null = null;
export function _decode_PollRepContent_Item (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PollRepContent_Item) { _cached_decoder_for_PollRepContent_Item = function (el: asn1.ASN1Element): PollRepContent_Item {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let certReqId!: asn1.INTEGER;
...
export function _encode_PollRepContent_Item (value: PollRepContent_Item, elGetter: __utils.ASN1Encoder<PollRepContent_Item>) {
    if (!_cached_encoder_for_PollRepContent_Item) { _cached_encoder_for_PollRepContent_Item = function (value: PollRepContent_Item, elGetter: __utils.ASN1Encoder<PollRepContent_Item>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeInteger(value.certReqId, __utils.BER),
...
let _cached_decoder_for_PollRepContent: __utils.ASN1Decoder<PollRepContent> | null = null;
let _cached_encoder_for_PollRepContent: __utils.ASN1Encoder<PollRepContent> | null = null;
export function _decode_PollRepContent (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PollRepContent) { _cached_decoder_for_PollRepContent = __utils._decodeSequenceOf<PollRepContent_Item>(() => _decode_PollRepContent_Item); }
    return _cached_decoder_for_PollRepContent(el);
}
export function _encode_PollRepContent (value: PollRepContent, elGetter: __utils.ASN1Encoder<PollRepContent>) {
    if (!_cached_encoder_for_PollRepContent) { _cached_encoder_for_PollRepContent = __utils._encodeSequenceOf<PollRepContent_Item>(() => _encode_PollRepContent_Item, __utils.BER); }
...
export function _decode_PKIBody (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PKIBody) { _cached_decoder_for_PKIBody = __utils._decode_inextensible_choice<PKIBody>({
...
export function _encode_PKIBody (value: PKIBody, elGetter: __utils.ASN1Encoder<PKIBody>) {
    if (!_cached_encoder_for_PKIBody) { _cached_encoder_for_PKIBody = __utils._encode_choice<PKIBody>({
...
let _cached_decoder_for_ProtectedPart: __utils.ASN1Decoder<ProtectedPart> | null = null;
let _cached_encoder_for_ProtectedPart: __utils.ASN1Encoder<ProtectedPart> | null = null;
export function _decode_ProtectedPart (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ProtectedPart) { _cached_decoder_for_ProtectedPart = function (el: asn1.ASN1Element): ProtectedPart {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
...
export function _encode_ProtectedPart (value: ProtectedPart, elGetter: __utils.ASN1Encoder<ProtectedPart>) {
    if (!_cached_encoder_for_ProtectedPart) { _cached_encoder_for_ProtectedPart = function (value: ProtectedPart, elGetter: __utils.ASN1Encoder<ProtectedPart>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_PKIHeader(value.header, __utils.BER),
            /* REQUIRED   */ _encode_PKIBody(value.body, __utils.BER)
...
let _cached_decoder_for_DHBMParameter: __utils.ASN1Decoder<DHBMParameter> | null = null;
let _cached_encoder_for_DHBMParameter: __utils.ASN1Encoder<DHBMParameter> | null = null;
export function _decode_DHBMParameter (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_DHBMParameter) { _cached_decoder_for_DHBMParameter = function (el: asn1.ASN1Element): DHBMParameter {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
...
export function _encode_DHBMParameter (value: DHBMParameter, elGetter: __utils.ASN1Encoder<DHBMParameter>) {
    if (!_cached_encoder_for_DHBMParameter) { _cached_encoder_for_DHBMParameter = function (value: DHBMParameter, elGetter: __utils.ASN1Encoder<DHBMParameter>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.owf, __utils.BER),
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.mac, __utils.BER)
...
export function _decode_OOBCert (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_OOBCert) { _cached_decoder_for_OOBCert = _decode_CMPCertificate; }
    return _cached_decoder_for_OOBCert(el);
}
export function _encode_OOBCert (value: OOBCert, elGetter: __utils.ASN1Encoder<OOBCert>) {
    if (!_cached_encoder_for_OOBCert) { _cached_encoder_for_OOBCert = _encode_CMPCertificate; }
